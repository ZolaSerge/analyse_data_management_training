...
ggsave(filename = "plots/bcz/katuba/scatterplot_score.pdf", plot = scatterplot_score)
...
ggsave(filename = "plots/bcz/katuba/whisker_box_score.pdf", plot = whisker_box_score)
