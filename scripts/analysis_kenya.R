...
ggsave(filename = "plots/bcz/kenya/scatterplot_score.pdf", plot = scatterplot_score)
...
ggsave(filename = "plots/bcz/kenya/whisker_box_score.pdf", plot = whisker_box_score)
