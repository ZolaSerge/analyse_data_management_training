...
ggsave(filename = "plots/bcz/ruashi/scatterplot_score.pdf", plot = scatterplot_score)
...
ggsave(filename = "plots/bcz/ruashi/whisker_box_score.pdf", plot = whisker_box_score)
